  ...
  return (
    <header>
      ...
      <nav className="fixed top-0 left-0 w-full bg-orange-50 p-4 z-50">
        ...
        >
          ...
          <div className="flex flex-col items-center space-y-6 mt-16">
            ...
            <Link href="/rooms" className="hover:text-orange-400" onClick={toggleMenu}>
              Rooms
            </Link>
            <Link href="/gallery" className="hover:text-orange-400" onClick={toggleMenu}>
              Gallery
            </Link>
            <Link href="/contact" className="hover:text-orange-400" onClick={toggleMenu}>
              Contact
            </Link>
            <Link
              href="/book"
              className="bg-customOrange px-4 py-2 text-white rounded shadow-lg hover:bg-orange-600"
              onClick={toggleMenu}
            >
              Book Now
            </Link>
      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="flex items-center justify-center h-full relative">
          <div className="text-center text-white p-6">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Welcome to Squirrel Resort</h2>
            <p className="text-lg md:text-2xl mb-6">Where Luxury Meets Nature</p>
            <Link
              href="/stay"
              className="px-6 py-3 text-lg font-medium bg-customOrange hover:bg-orange-600 rounded shadow-lg transition duration-300"
            >
